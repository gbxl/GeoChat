...
/**
 * 
 * Classe permettant l'interaction entre l'affichage et les données afficher dans les channels.
 *
 */
public class MessagesAdapter extends BaseAdapter {
	...
	public MessagesAdapter(Context context, List<Message> messages, String idChannel) {
	...
	public View getView(int position, View convertView, ViewGroup viewGroup) {
		...
		if (GeoChat.getInstance().getClient() != null && entry.getSender().toString().equals(GeoChat.getInstance().getClient().getUsername())) {
			contact.setText("Me : ");
		}
		else if (GeoChat.getInstance().getHost() != null && entry.getSender().toString().equals(GeoChat.getInstance().getHost().getUsername())) {
			contact.setText("Me : ");
		}
		else {
